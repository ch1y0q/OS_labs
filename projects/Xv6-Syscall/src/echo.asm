...
main(int argc, char *argv[])
{
  ...
  20:	7e 4b                	jle    6d <main+0x6d>
  22:	bb 01 00 00 00       	mov    $0x1,%ebx
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
  27:	83 c3 01             	add    $0x1,%ebx
  2a:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2e:	39 f3                	cmp    %esi,%ebx
  30:	74 26                	je     58 <main+0x58>
  32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  38:	68 98 07 00 00       	push   $0x798
  3d:	83 c3 01             	add    $0x1,%ebx
  40:	50                   	push   %eax
  41:	68 9a 07 00 00       	push   $0x79a
  46:	6a 01                	push   $0x1
  48:	e8 f3 03 00 00       	call   440 <printf>
  4d:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  51:	83 c4 10             	add    $0x10,%esp
  54:	39 f3                	cmp    %esi,%ebx
  56:	75 e0                	jne    38 <main+0x38>
  58:	68 9f 07 00 00       	push   $0x79f
  5d:	50                   	push   %eax
  5e:	68 9a 07 00 00       	push   $0x79a
  63:	6a 01                	push   $0x1
  65:	e8 d6 03 00 00       	call   440 <printf>
  6a:	83 c4 10             	add    $0x10,%esp
  exit();
  6d:	e8 71 02 00 00       	call   2e3 <exit>
  72:	66 90                	xchg   %ax,%ax
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 a8 07 00 00 	movzbl 0x7a8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e1:	e9 ae fe ff ff       	jmp    494 <printf+0x54>
          s = "(null)";
 5e6:	bb a1 07 00 00       	mov    $0x7a1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 58 0a 00 00       	mov    0xa58,%eax
{
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
