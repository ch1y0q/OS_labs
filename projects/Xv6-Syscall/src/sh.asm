...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      48:	80 3d 22 19 00 00 20 	cmpb   $0x20,0x1922
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      76:	6a 64                	push   $0x64
      78:	68 20 19 00 00       	push   $0x1920
      7d:	e8 8e 00 00 00       	call   110 <getcmd>
      82:	83 c4 10             	add    $0x10,%esp
      85:	85 c0                	test   %eax,%eax
      87:	78 14                	js     9d <main+0x9d>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      89:	80 3d 20 19 00 00 63 	cmpb   $0x63,0x1920
      90:	75 c6                	jne    58 <main+0x58>
      92:	80 3d 21 19 00 00 64 	cmpb   $0x64,0x1921
  ...
  exit();
      ...
      a5:	68 20 19 00 00       	push   $0x1920
      aa:	e8 01 0b 00 00       	call   bb0 <strlen>
      if(chdir(buf+3) < 0)
      af:	c7 04 24 23 19 00 00 	movl   $0x1923,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      b6:	c6 80 1f 19 00 00 00 	movb   $0x0,0x191f(%eax)
      if(chdir(buf+3) < 0)
      ...
      c9:	50                   	push   %eax
      ca:	68 23 19 00 00       	push   $0x1923
      cf:	68 f1 12 00 00       	push   $0x12f1
      d4:	6a 02                	push   $0x2
...
00000110 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     122:	68 48 12 00 00       	push   $0x1248
     127:	6a 02                	push   $0x2
...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     16d:	68 e5 12 00 00       	push   $0x12e5
     172:	6a 02                	push   $0x2
...
00000180 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     19d:	3e ff 24 85 00 13 00 	notrack jmp *0x1300(,%eax,4)
     1a4:	00 
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     242:	68 52 12 00 00       	push   $0x1252
     247:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     2c4:	68 77 12 00 00       	push   $0x1277
    ...
    panic("fork");
     ...
     32d:	68 72 12 00 00       	push   $0x1272
...
00000340 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     359:	68 72 12 00 00       	push   $0x1272
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     37b:	6a 54                	push   $0x54
     37d:	e8 be 0d 00 00       	call   1140 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3ab:	6a 18                	push   $0x18
     3ad:	e8 8e 0d 00 00       	call   1140 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3fb:	6a 0c                	push   $0xc
     3fd:	e8 3e 0d 00 00       	call   1140 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     43b:	6a 0c                	push   $0xc
     43d:	e8 fe 0c 00 00       	call   1140 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     47b:	6a 08                	push   $0x8
     47d:	e8 be 0c 00 00       	call   1140 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     4bd:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 10 19 00 00       	push   $0x1910
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 10 19 00 00       	push   $0x1910
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     56e:	50                   	push   %eax
     56f:	68 08 19 00 00       	push   $0x1908
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     590:	56                   	push   %esi
     591:	68 10 19 00 00       	push   $0x1910
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     63d:	50                   	push   %eax
     63e:	68 10 19 00 00       	push   $0x1910
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     6ab:	68 99 12 00 00       	push   $0x1299
     6b0:	53                   	push   %ebx
     6b1:	56                   	push   %esi
  ...
  return cmd;
     ...
     736:	68 7c 12 00 00       	push   $0x127c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     753:	68 9c 12 00 00       	push   $0x129c
     758:	57                   	push   %edi
     759:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7a6:	68 b3 12 00 00       	push   $0x12b3
     7ab:	57                   	push   %edi
     7ac:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7f0:	68 a5 12 00 00       	push   $0x12a5
  ...
  cmd->eargv[argc] = 0;
     ...
     842:	68 9e 12 00 00       	push   $0x129e
...
00000850 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     86d:	68 b8 12 00 00       	push   $0x12b8
  cmd = parseexec(ps, es);
...
000008c0 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     903:	68 ba 12 00 00       	push   $0x12ba
     908:	57                   	push   %edi
     909:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     919:	68 b6 12 00 00       	push   $0x12b6
     91e:	57                   	push   %edi
     91f:	56                   	push   %esi
...
00000970 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     983:	68 9c 12 00 00       	push   $0x129c
     988:	56                   	push   %esi
     989:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     9ad:	68 d8 12 00 00       	push   $0x12d8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a1d:	3e ff 24 85 18 13 00 	notrack jmp *0x1318(,%eax,4)
     a24:	00 
...
00000ac0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aeb:	68 61 12 00 00       	push   $0x1261
     af0:	53                   	push   %ebx
     af1:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b13:	52                   	push   %edx
     b14:	50                   	push   %eax
     b15:	68 da 12 00 00       	push   $0x12da
     b1a:	6a 02                	push   $0x2
     b1c:	e8 cf 03 00 00       	call   ef0 <printf>
    panic("syntax");
     b21:	c7 04 24 9e 12 00 00 	movl   $0x129e,(%esp)
     ...
     e4c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e79:	0f b6 92 38 13 00 00 	movzbl 0x1338(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f05:	0f 84 b9 00 00 00    	je     fc4 <printf+0xd4>
  ap = (uint*)(void*)&fmt + 1;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f4c:	74 76                	je     fc4 <printf+0xd4>
    c = fmt[i] & 0xff;
     f4e:	0f be cb             	movsbl %bl,%ecx
     f51:	0f b6 c3             	movzbl %bl,%eax
    if(c=='\r') continue;
     f54:	80 fb 0d             	cmp    $0xd,%bl
     f57:	74 eb                	je     f44 <printf+0x54>
    if(state == 0){
     f59:	85 d2                	test   %edx,%edx
     f5b:	74 c3                	je     f20 <printf+0x30>
      }
    } else if(state == '%'){
     f5d:	83 fa 25             	cmp    $0x25,%edx
     f60:	75 e2                	jne    f44 <printf+0x54>
      if(c == 'd'){
     f62:	83 f8 64             	cmp    $0x64,%eax
     f65:	0f 84 95 00 00 00    	je     1000 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
     f6b:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
     f71:	83 f9 70             	cmp    $0x70,%ecx
     f74:	74 5a                	je     fd0 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
     f76:	83 f8 73             	cmp    $0x73,%eax
     f79:	0f 84 91 00 00 00    	je     1010 <printf+0x120>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     f82:	0f 84 e8 00 00 00    	je     1070 <printf+0x180>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
     f88:	83 f8 25             	cmp    $0x25,%eax
     f8b:	0f 84 cf 00 00 00    	je     1060 <printf+0x170>
  write(fd, &c, 1);
     ...
     f9e:	e8 10 fe ff ff       	call   db3 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
     fa3:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
     ...
     fb2:	e8 fc fd ff ff       	call   db3 <write>
  for(i = 0; fmt[i]; i++){
     fb7:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
     fbb:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
     fbe:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
     fc0:	84 db                	test   %bl,%bl
     fc2:	75 8a                	jne    f4e <printf+0x5e>
    }
  }
}
     fc4:	8d 65 f4             	lea    -0xc(%ebp),%esp
     fc7:	5b                   	pop    %ebx
     fc8:	5e                   	pop    %esi
     fc9:	5f                   	pop    %edi
     fca:	5d                   	pop    %ebp
    ...
    101d:	74 77                	je     1096 <printf+0x1a6>
        while(*s != 0){
    ...
    1026:	0f 84 18 ff ff ff    	je     f44 <printf+0x54>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10b5:	a1 84 19 00 00       	mov    0x1984,%eax
{
    ...
    10d6:	73 10                	jae    10e8 <free+0x38>
{
  ...
  freep = p;
    ...
    1101:	5b                   	pop    %ebx
  freep = p;
    1102:	a3 84 19 00 00       	mov    %eax,0x1984
}
    1107:	5e                   	pop    %esi
    1108:	5f                   	pop    %edi
    1109:	5d                   	pop    %ebp
  ...
  freep = p;
    112a:	a3 84 19 00 00       	mov    %eax,0x1984
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1150:	8b 3d 84 19 00 00    	mov    0x1984,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1199:	8b 3d 84 19 00 00    	mov    0x1984,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    11ab:	e8 6b fc ff ff       	call   e1b <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    11c7:	a1 84 19 00 00       	mov    0x1984,%eax
    ...
    11f4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    11f7:	a3 84 19 00 00       	mov    %eax,0x1984
}
    ...
    1217:	19 00 00 
    base.s.size = 0;
    121a:	bf 88 19 00 00       	mov    $0x1988,%edi
    base.s.ptr = freep = prevp = &base;
    121f:	c7 05 88 19 00 00 88 	movl   $0x1988,0x1988
    1226:	19 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1229:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    122b:	c7 05 8c 19 00 00 00 	movl   $0x0,0x198c
    1232:	00 00 00 
    if(p->s.size >= nunits){
