 ...
 23d:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
{
 ...
 25d:	50                   	push   %eax
 25e:	8d 81 60 0e 00 00    	lea    0xe60(%ecx),%eax
 264:	50                   	push   %eax
 ...
 27b:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    p = buf;
 27e:	bb 60 0e 00 00       	mov    $0xe60,%ebx
    buf[m] = '\0';
 283:	c6 81 60 0e 00 00 00 	movb   $0x0,0xe60(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2de:	eb b0                	jmp    290 <grep+0x60>
    if(p == buf)
 2e0:	81 fb 60 0e 00 00    	cmp    $0xe60,%ebx
 ...
 2f5:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f8:	2d 60 0e 00 00       	sub    $0xe60,%eax
 2fd:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2ff:	51                   	push   %ecx
 300:	53                   	push   %ebx
 301:	68 60 0e 00 00       	push   $0xe60
      m -= p - buf;
...
printf(int fd, const char *fmt, ...)
{
 ...
 8a1:	e9 ae fe ff ff       	jmp    754 <printf+0x54>
          s = "(null)";
 8a6:	bb 8e 0a 00 00       	mov    $0xa8e,%ebx
        while(*s != 0){
