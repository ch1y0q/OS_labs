...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12f:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "iput test ok\n");
     ...
     195:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1ac:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1c3:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1da:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1f1:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00000210 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     21f:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     295:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     2b0:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "fork failed\n");
     ...
     2c7:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    exit();
     ...
     2de:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     2f5:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00000310 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     31f:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     36a:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3aa:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "fork failed\n");
     ...
     3cc:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3e3:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "unlink failed\n");
     ...
     3fa:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     41f:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "open test ok\n");
     ...
     465:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "open echo failed!\n");
     ...
     47c:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     493:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
000004b0 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4c1:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4f4:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "writes ok\n");
     ...
     550:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     586:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     5ba:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e8:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     606:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     61f:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     636:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "read failed\n");
     ...
     64d:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "unlink small failed\n");
     ...
     664:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     67b:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00000690 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     6a1:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "big files ok\n");
     ...
     795:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     7b3:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     7ca:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     7e3:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     7fe:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     815:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     82c:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "unlink big failed\n");
     ...
     843:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     875:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     906:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00000920 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     92f:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     995:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "mkdir failed\n");
     ...
     9ac:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     9c3:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9da:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9f1:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00000a10 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     a1f:	ff 35 d0 5e 00 00    	pushl  0x5ed0
     a25:	e8 b6 30 00 00       	call   3ae0 <printf>
  if(exec("echo", echoargv) < 0){
     a2a:	5a                   	pop    %edx
     a2b:	59                   	pop    %ecx
     a2c:	68 d4 5e 00 00       	push   $0x5ed4
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a4b:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00000c00 <preempt>:
{
  ...
  printf(1, "preempt ok\n");
     ...
     d2a:	68 d6 41 00 00       	push   $0x41d6
     d2f:	6a 01                	push   $0x1
    ...
    printf(1, "preempt read error");
     ...
     d41:	68 ea 41 00 00       	push   $0x41ea
     d46:	6a 01                	push   $0x1
    ...
    127a:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete ok\n");
    ...
    1384:	68 03 43 00 00       	push   $0x4303
    1389:	6a 01                	push   $0x1
    ...
    1422:	52                   	push   %edx
    1423:	52                   	push   %edx
    1424:	68 f1 3e 00 00       	push   $0x3ef1
    1429:	6a 01                	push   $0x1
    ...
    1443:	57                   	push   %edi
    1444:	68 b0 4f 00 00       	push   $0x4fb0
    1449:	6a 01                	push   $0x1
    ...
    1458:	68 3f 45 00 00       	push   $0x453f
    145d:	6a 01                	push   $0x1
    ...
    146c:	68 79 4d 00 00       	push   $0x4d79
    1471:	6a 01                	push   $0x1
    ...
    1488:	50                   	push   %eax
    1489:	57                   	push   %edi
    148a:	68 d4 4f 00 00       	push   $0x4fd4
    148f:	6a 01                	push   $0x1
...
000014a0 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    14ac:	68 14 43 00 00       	push   $0x4314
    14b1:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14bf:	68 25 43 00 00       	push   $0x4325
  ...
  write(fd, "hello", 5);
    ...
    14d9:	6a 05                	push   $0x5
    14db:	68 4a 43 00 00       	push   $0x434a
    14e0:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    14ef:	5a                   	pop    %edx
    14f0:	6a 02                	push   $0x2
    14f2:	68 25 43 00 00       	push   $0x4325
  ...
  if(unlink("unlinkread") != 0){
    ...
    150c:	68 25 43 00 00       	push   $0x4325
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1529:	68 25 43 00 00       	push   $0x4325
  ...
  write(fd1, "yyy", 3);
    153a:	68 82 43 00 00       	push   $0x4382
    153f:	50                   	push   %eax
  ...
  unlink("unlinkread");
    1596:	c7 04 24 25 43 00 00 	movl   $0x4325,(%esp)
    159d:	e8 31 24 00 00       	call   39d3 <unlink>
  printf(1, "unlinkread ok\n");
    15a2:	58                   	pop    %eax
    15a3:	5a                   	pop    %edx
    15a4:	68 cd 43 00 00       	push   $0x43cd
    15a9:	6a 01                	push   $0x1
    ...
    15ba:	51                   	push   %ecx
    15bb:	51                   	push   %ecx
    15bc:	68 30 43 00 00       	push   $0x4330
    15c1:	6a 01                	push   $0x1
    ...
    15cd:	51                   	push   %ecx
    15ce:	51                   	push   %ecx
    15cf:	68 b4 43 00 00       	push   $0x43b4
    15d4:	6a 01                	push   $0x1
    ...
    15e0:	53                   	push   %ebx
    15e1:	53                   	push   %ebx
    15e2:	68 9d 43 00 00       	push   $0x439d
    15e7:	6a 01                	push   $0x1
    ...
    15f3:	56                   	push   %esi
    15f4:	56                   	push   %esi
    15f5:	68 86 43 00 00       	push   $0x4386
    15fa:	6a 01                	push   $0x1
    ...
    1606:	50                   	push   %eax
    1607:	50                   	push   %eax
    1608:	68 68 43 00 00       	push   $0x4368
    160d:	6a 01                	push   $0x1
    ...
    1619:	50                   	push   %eax
    161a:	50                   	push   %eax
    161b:	68 50 43 00 00       	push   $0x4350
    1620:	6a 01                	push   $0x1
...
00001630 <linktest>:
{
  ...
  printf(1, "linktest\n");
    163b:	68 dc 43 00 00       	push   $0x43dc
    1640:	6a 01                	push   $0x1
    1642:	e8 99 24 00 00       	call   3ae0 <printf>
  unlink("lf1");
    1647:	c7 04 24 e6 43 00 00 	movl   $0x43e6,(%esp)
    164e:	e8 80 23 00 00       	call   39d3 <unlink>
  unlink("lf2");
    1653:	c7 04 24 ea 43 00 00 	movl   $0x43ea,(%esp)
    165a:	e8 74 23 00 00       	call   39d3 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    165f:	58                   	pop    %eax
    1660:	5a                   	pop    %edx
    1661:	68 02 02 00 00       	push   $0x202
    1666:	68 e6 43 00 00       	push   $0x43e6
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1680:	6a 05                	push   $0x5
    1682:	68 4a 43 00 00       	push   $0x434a
    1687:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    16a2:	5b                   	pop    %ebx
    16a3:	58                   	pop    %eax
    16a4:	68 ea 43 00 00       	push   $0x43ea
    16a9:	68 e6 43 00 00       	push   $0x43e6
  ...
  unlink("lf1");
    ...
    16c1:	68 e6 43 00 00       	push   $0x43e6
    16c6:	e8 08 23 00 00       	call   39d3 <unlink>
  if(open("lf1", 0) >= 0){
    16cb:	58                   	pop    %eax
    16cc:	5a                   	pop    %edx
    16cd:	6a 00                	push   $0x0
    16cf:	68 e6 43 00 00       	push   $0x43e6
  ...
  fd = open("lf2", 0);
    ...
    16e7:	6a 00                	push   $0x0
    16e9:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(link("lf2", "lf2") >= 0){
    1728:	58                   	pop    %eax
    1729:	5a                   	pop    %edx
    172a:	68 ea 43 00 00       	push   $0x43ea
    172f:	68 ea 43 00 00       	push   $0x43ea
  ...
  unlink("lf2");
    ...
    1747:	68 ea 43 00 00       	push   $0x43ea
    174c:	e8 82 22 00 00       	call   39d3 <unlink>
  if(link("lf2", "lf1") >= 0){
    1751:	59                   	pop    %ecx
    1752:	5b                   	pop    %ebx
    1753:	68 e6 43 00 00       	push   $0x43e6
    1758:	68 ea 43 00 00       	push   $0x43ea
  ...
  if(link(".", "lf1") >= 0){
    ...
    176c:	68 e6 43 00 00       	push   $0x43e6
    1771:	68 ae 46 00 00       	push   $0x46ae
  ...
  printf(1, "linktest ok\n");
    ...
    1785:	68 84 44 00 00       	push   $0x4484
    178a:	6a 01                	push   $0x1
    ...
    1799:	50                   	push   %eax
    179a:	50                   	push   %eax
    179b:	68 ee 43 00 00       	push   $0x43ee
    17a0:	6a 01                	push   $0x1
    ...
    17ac:	50                   	push   %eax
    17ad:	50                   	push   %eax
    17ae:	68 68 44 00 00       	push   $0x4468
    17b3:	6a 01                	push   $0x1
    ...
    17bf:	52                   	push   %edx
    17c0:	52                   	push   %edx
    17c1:	68 1c 50 00 00       	push   $0x501c
    17c6:	6a 01                	push   $0x1
    ...
    17d2:	50                   	push   %eax
    17d3:	50                   	push   %eax
    17d4:	68 4a 44 00 00       	push   $0x444a
    17d9:	6a 01                	push   $0x1
    ...
    17e5:	51                   	push   %ecx
    17e6:	51                   	push   %ecx
    17e7:	68 39 44 00 00       	push   $0x4439
    17ec:	6a 01                	push   $0x1
    ...
    17f8:	53                   	push   %ebx
    17f9:	53                   	push   %ebx
    17fa:	68 28 44 00 00       	push   $0x4428
    17ff:	6a 01                	push   $0x1
    ...
    180b:	50                   	push   %eax
    180c:	50                   	push   %eax
    180d:	68 f4 4f 00 00       	push   $0x4ff4
    1812:	6a 01                	push   $0x1
    ...
    181e:	51                   	push   %ecx
    181f:	51                   	push   %ecx
    1820:	68 13 44 00 00       	push   $0x4413
    1825:	6a 01                	push   $0x1
    ...
    1831:	50                   	push   %eax
    1832:	50                   	push   %eax
    1833:	68 01 44 00 00       	push   $0x4401
    1838:	6a 01                	push   $0x1
    ...
    1859:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    1862:	68 91 44 00 00       	push   $0x4491
    1867:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1908:	53                   	push   %ebx
    1909:	68 a4 44 00 00       	push   $0x44a4
    190e:	6a 01                	push   $0x1
    ...
    1923:	53                   	push   %ebx
    1924:	68 a1 44 00 00       	push   $0x44a1
  ...
  for(i = 0; i < 40; i++){
    1943:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    1946:	53                   	push   %ebx
    1947:	68 a1 44 00 00       	push   $0x44a1
  ...
  fd = open(".", 0);
    ...
    1973:	5f                   	pop    %edi
    1974:	6a 00                	push   $0x0
    1976:	68 ae 46 00 00       	push   $0x46ae
  ...
  printf(1, "concreate ok\n");
    ...
    1ad3:	68 f6 44 00 00       	push   $0x44f6
    1ad8:	6a 01                	push   $0x1
    ...
    1aea:	68 79 4d 00 00       	push   $0x4d79
    1aef:	6a 01                	push   $0x1
    ...
    1afb:	51                   	push   %ecx
    1afc:	51                   	push   %ecx
    1afd:	68 40 50 00 00       	push   $0x5040
    1b02:	6a 01                	push   $0x1
    ...
    1b14:	50                   	push   %eax
    1b15:	68 d9 44 00 00       	push   $0x44d9
    1b1a:	6a 01                	push   $0x1
    ...
    1b2c:	50                   	push   %eax
    1b2d:	68 c0 44 00 00       	push   $0x44c0
    1b32:	6a 01                	push   $0x1
...
00001b50 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1b5d:	68 04 45 00 00       	push   $0x4504
    1b62:	6a 01                	push   $0x1
    1b64:	e8 77 1f 00 00       	call   3ae0 <printf>
  unlink("x");
    1b69:	c7 04 24 91 47 00 00 	movl   $0x4791,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ba8:	68 91 47 00 00       	push   $0x4791
  ...
  for(i = 0; i < 100; i++){
    ...
    1be1:	68 91 47 00 00       	push   $0x4791
  ...
  printf(1, "linkunlink ok\n");
    ...
    1c0a:	68 19 45 00 00       	push   $0x4519
    1c0f:	6a 01                	push   $0x1
    ...
    1c23:	68 91 47 00 00       	push   $0x4791
    1c28:	68 15 45 00 00       	push   $0x4515
    ...
    1c3a:	52                   	push   %edx
    1c3b:	52                   	push   %edx
    1c3c:	68 79 4d 00 00       	push   $0x4d79
    1c41:	6a 01                	push   $0x1
...
00001c60 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1c6d:	68 28 45 00 00       	push   $0x4528
    1c72:	6a 01                	push   $0x1
    1c74:	e8 67 1e 00 00       	call   3ae0 <printf>
  unlink("bd");
    1c79:	c7 04 24 35 45 00 00 	movl   $0x4535,(%esp)
    1c80:	e8 4e 1d 00 00       	call   39d3 <unlink>
  fd = open("bd", O_CREATE);
    1c85:	5a                   	pop    %edx
    1c86:	59                   	pop    %ecx
    1c87:	68 00 02 00 00       	push   $0x200
    1c8c:	68 35 45 00 00       	push   $0x4535
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1cc8:	68 35 45 00 00       	push   $0x4535
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1cfb:	68 35 45 00 00       	push   $0x4535
  ...
  printf(1, "bigdir ok\n");
    ...
    1d4c:	68 77 45 00 00       	push   $0x4577
    1d51:	6a 01                	push   $0x1
    ...
    1d66:	68 4e 45 00 00       	push   $0x454e
    1d6b:	6a 01                	push   $0x1
    ...
    1d7a:	68 62 45 00 00       	push   $0x4562
    1d7f:	6a 01                	push   $0x1
    ...
    1d8b:	50                   	push   %eax
    1d8c:	50                   	push   %eax
    1d8d:	68 38 45 00 00       	push   $0x4538
    1d92:	6a 01                	push   $0x1
...
00001da0 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1dab:	68 82 45 00 00       	push   $0x4582
    1db0:	6a 01                	push   $0x1
    1db2:	e8 29 1d 00 00       	call   3ae0 <printf>
  unlink("ff");
    1db7:	c7 04 24 0b 46 00 00 	movl   $0x460b,(%esp)
    1dbe:	e8 10 1c 00 00       	call   39d3 <unlink>
  if(mkdir("dd") != 0){
    1dc3:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1de2:	68 e1 45 00 00       	push   $0x45e1
  ...
  write(fd, "ff", 2);
    ...
    1dfc:	6a 02                	push   $0x2
    1dfe:	68 0b 46 00 00       	push   $0x460b
    1e03:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1e11:	c7 04 24 a8 46 00 00 	movl   $0x46a8,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1e2b:	68 bc 45 00 00       	push   $0x45bc
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1e48:	68 de 45 00 00       	push   $0x45de
  ...
  write(fd, "FF", 2);
    ...
    1e62:	6a 02                	push   $0x2
    1e64:	68 ff 45 00 00       	push   $0x45ff
    1e69:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e78:	5a                   	pop    %edx
    1e79:	6a 00                	push   $0x0
    1e7b:	68 02 46 00 00       	push   $0x4602
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1ec7:	59                   	pop    %ecx
    1ec8:	5b                   	pop    %ebx
    1ec9:	68 42 46 00 00       	push   $0x4642
    1ece:	68 de 45 00 00       	push   $0x45de
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1ee6:	68 de 45 00 00       	push   $0x45de
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1efe:	6a 00                	push   $0x0
    1f00:	68 de 45 00 00       	push   $0x45de
  ...
  if(chdir("dd") != 0){
    ...
    1f18:	68 a8 46 00 00       	push   $0x46a8
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1f30:	68 76 46 00 00       	push   $0x4676
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f48:	68 9c 46 00 00       	push   $0x469c
  ...
  if(chdir("./..") != 0){
    ...
    1f60:	68 ab 46 00 00       	push   $0x46ab
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f78:	6a 00                	push   $0x0
    1f7a:	68 42 46 00 00       	push   $0x4642
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1fba:	5a                   	pop    %edx
    1fbb:	6a 00                	push   $0x0
    1fbd:	68 de 45 00 00       	push   $0x45de
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1fda:	68 f6 46 00 00       	push   $0x46f6
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1ff7:	68 1b 47 00 00       	push   $0x471b
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2014:	68 a8 46 00 00       	push   $0x46a8
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    202c:	6a 02                	push   $0x2
    202e:	68 a8 46 00 00       	push   $0x46a8
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2046:	6a 01                	push   $0x1
    2048:	68 a8 46 00 00       	push   $0x46a8
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2060:	68 8a 47 00 00       	push   $0x478a
    2065:	68 f6 46 00 00       	push   $0x46f6
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    207d:	68 8a 47 00 00       	push   $0x478a
    2082:	68 1b 47 00 00       	push   $0x471b
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    209a:	68 42 46 00 00       	push   $0x4642
    209f:	68 e1 45 00 00       	push   $0x45e1
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    20b7:	68 f6 46 00 00       	push   $0x46f6
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    20e7:	68 42 46 00 00       	push   $0x4642
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    20ff:	68 1b 47 00 00       	push   $0x471b
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2117:	68 f6 46 00 00       	push   $0x46f6
  ...
  if(chdir("dd/ff") == 0){
    ...
    212f:	68 e1 45 00 00       	push   $0x45e1
  ...
  if(chdir("dd/xx") == 0){
    ...
    2147:	68 8d 47 00 00       	push   $0x478d
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    215f:	68 42 46 00 00       	push   $0x4642
  ...
  if(unlink("dd/ff") != 0){
    ...
    2177:	68 e1 45 00 00       	push   $0x45e1
  ...
  if(unlink("dd/dd") < 0){
    ...
    21a7:	68 bd 45 00 00       	push   $0x45bd
  ...
  if(unlink("dd") < 0){
    ...
    21bf:	68 a8 46 00 00       	push   $0x46a8
  ...
  printf(1, "subdir ok\n");
    ...
    21d7:	68 8a 48 00 00       	push   $0x488a
    21dc:	6a 01                	push   $0x1
    ...
    21eb:	50                   	push   %eax
    21ec:	50                   	push   %eax
    21ed:	68 27 46 00 00       	push   $0x4627
    21f2:	6a 01                	push   $0x1
    ...
    21fe:	50                   	push   %eax
    21ff:	50                   	push   %eax
    2200:	68 82 46 00 00       	push   $0x4682
    2205:	6a 01                	push   $0x1
    ...
    2211:	50                   	push   %eax
    2212:	50                   	push   %eax
    2213:	68 4d 46 00 00       	push   $0x464d
    2218:	6a 01                	push   $0x1
    ...
    2224:	51                   	push   %ecx
    2225:	51                   	push   %ecx
    2226:	68 ff 46 00 00       	push   $0x46ff
    222b:	6a 01                	push   $0x1
    ...
    2237:	53                   	push   %ebx
    2238:	53                   	push   %ebx
    2239:	68 e4 50 00 00       	push   $0x50e4
    223e:	6a 01                	push   $0x1
    ...
    224a:	51                   	push   %ecx
    224b:	51                   	push   %ecx
    224c:	68 93 47 00 00       	push   $0x4793
    2251:	6a 01                	push   $0x1
    ...
    225d:	53                   	push   %ebx
    225e:	53                   	push   %ebx
    225f:	68 54 51 00 00       	push   $0x5154
    2264:	6a 01                	push   $0x1
    ...
    2270:	50                   	push   %eax
    2271:	50                   	push   %eax
    2272:	68 0e 46 00 00       	push   $0x460e
    2277:	6a 01                	push   $0x1
    ...
    2283:	51                   	push   %ecx
    2284:	51                   	push   %ecx
    2285:	68 e7 45 00 00       	push   $0x45e7
    228a:	6a 01                	push   $0x1
    ...
    2296:	50                   	push   %eax
    2297:	50                   	push   %eax
    2298:	68 b0 46 00 00       	push   $0x46b0
    229d:	6a 01                	push   $0x1
    ...
    22a9:	52                   	push   %edx
    22aa:	52                   	push   %edx
    22ab:	68 9c 50 00 00       	push   $0x509c
    22b0:	6a 01                	push   $0x1
    ...
    22bc:	50                   	push   %eax
    22bd:	50                   	push   %eax
    22be:	68 30 51 00 00       	push   $0x5130
    22c3:	6a 01                	push   $0x1
    ...
    22cf:	50                   	push   %eax
    22d0:	50                   	push   %eax
    22d1:	68 0c 51 00 00       	push   $0x510c
    22d6:	6a 01                	push   $0x1
    ...
    22e2:	50                   	push   %eax
    22e3:	50                   	push   %eax
    22e4:	68 6f 47 00 00       	push   $0x476f
    22e9:	6a 01                	push   $0x1
    ...
    22f5:	50                   	push   %eax
    22f6:	50                   	push   %eax
    22f7:	68 56 47 00 00       	push   $0x4756
    22fc:	6a 01                	push   $0x1
    ...
    2308:	50                   	push   %eax
    2309:	50                   	push   %eax
    230a:	68 40 47 00 00       	push   $0x4740
    230f:	6a 01                	push   $0x1
    ...
    231b:	52                   	push   %edx
    231c:	52                   	push   %edx
    231d:	68 24 47 00 00       	push   $0x4724
    2322:	6a 01                	push   $0x1
    ...
    232e:	50                   	push   %eax
    232f:	50                   	push   %eax
    2330:	68 65 46 00 00       	push   $0x4665
    2335:	6a 01                	push   $0x1
    ...
    2341:	50                   	push   %eax
    2342:	50                   	push   %eax
    2343:	68 c0 50 00 00       	push   $0x50c0
    2348:	6a 01                	push   $0x1
    ...
    2354:	53                   	push   %ebx
    2355:	53                   	push   %ebx
    2356:	68 c3 45 00 00       	push   $0x45c3
    235b:	6a 01                	push   $0x1
    ...
    2367:	50                   	push   %eax
    2368:	50                   	push   %eax
    2369:	68 74 50 00 00       	push   $0x5074
    236e:	6a 01                	push   $0x1
    ...
    237a:	50                   	push   %eax
    237b:	50                   	push   %eax
    237c:	68 a7 45 00 00       	push   $0x45a7
    2381:	6a 01                	push   $0x1
    ...
    238d:	50                   	push   %eax
    238e:	50                   	push   %eax
    238f:	68 8f 45 00 00       	push   $0x458f
    2394:	6a 01                	push   $0x1
    ...
    23a0:	50                   	push   %eax
    23a1:	50                   	push   %eax
    23a2:	68 78 48 00 00       	push   $0x4878
    23a7:	6a 01                	push   $0x1
    ...
    23b3:	52                   	push   %edx
    23b4:	52                   	push   %edx
    23b5:	68 63 48 00 00       	push   $0x4863
    23ba:	6a 01                	push   $0x1
    ...
    23c6:	51                   	push   %ecx
    23c7:	51                   	push   %ecx
    23c8:	68 78 51 00 00       	push   $0x5178
    23cd:	6a 01                	push   $0x1
    ...
    23d9:	53                   	push   %ebx
    23da:	53                   	push   %ebx
    23db:	68 4e 48 00 00       	push   $0x484e
    23e0:	6a 01                	push   $0x1
    ...
    23ec:	50                   	push   %eax
    23ed:	50                   	push   %eax
    23ee:	68 36 48 00 00       	push   $0x4836
    23f3:	6a 01                	push   $0x1
    ...
    23ff:	50                   	push   %eax
    2400:	50                   	push   %eax
    2401:	68 1e 48 00 00       	push   $0x481e
    2406:	6a 01                	push   $0x1
    ...
    2412:	50                   	push   %eax
    2413:	50                   	push   %eax
    2414:	68 02 48 00 00       	push   $0x4802
    2419:	6a 01                	push   $0x1
    ...
    2425:	50                   	push   %eax
    2426:	50                   	push   %eax
    2427:	68 e6 47 00 00       	push   $0x47e6
    242c:	6a 01                	push   $0x1
    ...
    2438:	50                   	push   %eax
    2439:	50                   	push   %eax
    243a:	68 c9 47 00 00       	push   $0x47c9
    243f:	6a 01                	push   $0x1
    ...
    244b:	52                   	push   %edx
    244c:	52                   	push   %edx
    244d:	68 ae 47 00 00       	push   $0x47ae
    2452:	6a 01                	push   $0x1
    ...
    245e:	51                   	push   %ecx
    245f:	51                   	push   %ecx
    2460:	68 db 46 00 00       	push   $0x46db
    2465:	6a 01                	push   $0x1
    ...
    2471:	53                   	push   %ebx
    2472:	53                   	push   %ebx
    2473:	68 c3 46 00 00       	push   $0x46c3
    2478:	6a 01                	push   $0x1
...
00002490 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    24a1:	68 95 48 00 00       	push   $0x4895
    24a6:	6a 01                	push   $0x1
    24a8:	e8 33 16 00 00       	call   3ae0 <printf>
  unlink("bigwrite");
    24ad:	c7 04 24 a4 48 00 00 	movl   $0x48a4,(%esp)
    ...
    24c8:	68 a4 48 00 00       	push   $0x48a4
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2516:	c7 04 24 a4 48 00 00 	movl   $0x48a4,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2530:	68 d7 48 00 00       	push   $0x48d7
    2535:	6a 01                	push   $0x1
    ...
    2546:	50                   	push   %eax
    2547:	53                   	push   %ebx
    2548:	68 c5 48 00 00       	push   $0x48c5
    254d:	6a 01                	push   $0x1
    ...
    255c:	68 ad 48 00 00       	push   $0x48ad
    2561:	6a 01                	push   $0x1
...
00002570 <bigfile>:
{
  ...
  fd = open("bigfile", 0);
    ...
    25fe:	5f                   	pop    %edi
    25ff:	6a 00                	push   $0x0
    2601:	68 00 49 00 00       	push   $0x4900
  ...
  unlink("bigfile");
    ...
    2685:	68 00 49 00 00       	push   $0x4900
    268a:	e8 44 13 00 00       	call   39d3 <unlink>
  printf(1, "bigfile test ok\n");
    268f:	58                   	pop    %eax
    2690:	5a                   	pop    %edx
    2691:	68 8f 49 00 00       	push   $0x498f
    2696:	6a 01                	push   $0x1
    ...
    26ab:	68 5c 49 00 00       	push   $0x495c
    26b0:	6a 01                	push   $0x1
    ...
    26bf:	68 48 49 00 00       	push   $0x4948
    26c4:	6a 01                	push   $0x1
    ...
    26d3:	68 33 49 00 00       	push   $0x4933
    26d8:	6a 01                	push   $0x1
    ...
    26e7:	68 08 49 00 00       	push   $0x4908
    26ec:	6a 01                	push   $0x1
    ...
    26f8:	53                   	push   %ebx
    26f9:	53                   	push   %ebx
    26fa:	68 1e 49 00 00       	push   $0x491e
    26ff:	6a 01                	push   $0x1
    ...
    270b:	50                   	push   %eax
    270c:	50                   	push   %eax
    270d:	68 f2 48 00 00       	push   $0x48f2
    2712:	6a 01                	push   $0x1
    ...
    271e:	51                   	push   %ecx
    271f:	51                   	push   %ecx
    2720:	68 75 49 00 00       	push   $0x4975
    2725:	6a 01                	push   $0x1
...
00002740 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    274a:	68 a0 49 00 00       	push   $0x49a0
    274f:	6a 01                	push   $0x1
    2751:	e8 8a 13 00 00       	call   3ae0 <printf>
  if(mkdir("12345678901234") != 0){
    2756:	c7 04 24 db 49 00 00 	movl   $0x49db,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2770:	68 98 51 00 00       	push   $0x5198
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    278d:	68 e8 51 00 00       	push   $0x51e8
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27ac:	5a                   	pop    %edx
    27ad:	6a 00                	push   $0x0
    27af:	68 58 52 00 00       	push   $0x5258
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    27c9:	c7 04 24 cc 49 00 00 	movl   $0x49cc,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    27df:	68 f4 52 00 00       	push   $0x52f4
  ...
  printf(1, "fourteen ok\n");
    ...
    27f3:	68 ea 49 00 00       	push   $0x49ea
    27f8:	6a 01                	push   $0x1
    ...
    2804:	50                   	push   %eax
    2805:	50                   	push   %eax
    2806:	68 af 49 00 00       	push   $0x49af
    280b:	6a 01                	push   $0x1
    ...
    2817:	50                   	push   %eax
    2818:	50                   	push   %eax
    2819:	68 14 53 00 00       	push   $0x5314
    281e:	6a 01                	push   $0x1
    ...
    282a:	52                   	push   %edx
    282b:	52                   	push   %edx
    282c:	68 c4 52 00 00       	push   $0x52c4
    2831:	6a 01                	push   $0x1
    ...
    283d:	51                   	push   %ecx
    283e:	51                   	push   %ecx
    283f:	68 88 52 00 00       	push   $0x5288
    2844:	6a 01                	push   $0x1
    ...
    2850:	51                   	push   %ecx
    2851:	51                   	push   %ecx
    2852:	68 18 52 00 00       	push   $0x5218
    2857:	6a 01                	push   $0x1
    ...
    2863:	50                   	push   %eax
    2864:	50                   	push   %eax
    2865:	68 b8 51 00 00       	push   $0x51b8
    286a:	6a 01                	push   $0x1
...
00002880 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    288a:	68 f7 49 00 00       	push   $0x49f7
    288f:	6a 01                	push   $0x1
    2891:	e8 4a 12 00 00       	call   3ae0 <printf>
  if(mkdir("dots") != 0){
    2896:	c7 04 24 03 4a 00 00 	movl   $0x4a03,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    28b0:	68 03 4a 00 00       	push   $0x4a03
  ...
  if(unlink(".") == 0){
    ...
    28c8:	68 ae 46 00 00       	push   $0x46ae
  ...
  if(unlink("..") == 0){
    ...
    28e0:	68 ad 46 00 00       	push   $0x46ad
  ...
  if(chdir("/") != 0){
    ...
    28f8:	68 81 3e 00 00       	push   $0x3e81
  ...
  if(unlink("dots/.") == 0){
    ...
    2910:	68 4b 4a 00 00       	push   $0x4a4b
  ...
  if(unlink("dots/..") == 0){
    ...
    2924:	68 69 4a 00 00       	push   $0x4a69
  ...
  if(unlink("dots") != 0){
    ...
    2938:	68 03 4a 00 00       	push   $0x4a03
  ...
  printf(1, "rmdot ok\n");
    ...
    294c:	68 9e 4a 00 00       	push   $0x4a9e
    2951:	6a 01                	push   $0x1
    ...
    295d:	50                   	push   %eax
    295e:	50                   	push   %eax
    295f:	68 08 4a 00 00       	push   $0x4a08
    2964:	6a 01                	push   $0x1
    ...
    2970:	50                   	push   %eax
    2971:	50                   	push   %eax
    2972:	68 89 4a 00 00       	push   $0x4a89
    2977:	6a 01                	push   $0x1
    ...
    2983:	52                   	push   %edx
    2984:	52                   	push   %edx
    2985:	68 71 4a 00 00       	push   $0x4a71
    298a:	6a 01                	push   $0x1
    ...
    2996:	51                   	push   %ecx
    2997:	51                   	push   %ecx
    2998:	68 52 4a 00 00       	push   $0x4a52
    299d:	6a 01                	push   $0x1
    ...
    29a9:	50                   	push   %eax
    29aa:	50                   	push   %eax
    29ab:	68 83 3e 00 00       	push   $0x3e83
    29b0:	6a 01                	push   $0x1
    ...
    29bc:	50                   	push   %eax
    29bd:	50                   	push   %eax
    29be:	68 3c 4a 00 00       	push   $0x4a3c
    29c3:	6a 01                	push   $0x1
    ...
    29e2:	50                   	push   %eax
    29e3:	50                   	push   %eax
    29e4:	68 1b 4a 00 00       	push   $0x4a1b
    29e9:	6a 01                	push   $0x1
...
00002a00 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2a0b:	68 a8 4a 00 00       	push   $0x4aa8
    2a10:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a1e:	68 b5 4a 00 00       	push   $0x4ab5
  ...
  if(chdir("dirfile") == 0){
    2a3c:	c7 04 24 b5 4a 00 00 	movl   $0x4ab5,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a56:	6a 00                	push   $0x0
    2a58:	68 ee 4a 00 00       	push   $0x4aee
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2aa5:	68 ee 4a 00 00       	push   $0x4aee
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2abd:	68 ee 4a 00 00       	push   $0x4aee
    2ac2:	68 52 4b 00 00       	push   $0x4b52
  ...
  if(unlink("dirfile") != 0){
    ...
    2ada:	68 b5 4a 00 00       	push   $0x4ab5
  ...
  fd = open(".", O_RDWR);
    ...
    2af2:	6a 02                	push   $0x2
    2af4:	68 ae 46 00 00       	push   $0x46ae
  ...
  fd = open(".", 0);
    ...
    2b0c:	6a 00                	push   $0x0
    2b0e:	68 ae 46 00 00       	push   $0x46ae
  ...
  if(write(fd, "x", 1) > 0){
    2b1f:	68 91 47 00 00       	push   $0x4791
    2b24:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2b3a:	58                   	pop    %eax
    2b3b:	5a                   	pop    %edx
    2b3c:	68 85 4b 00 00       	push   $0x4b85
    2b41:	6a 01                	push   $0x1
    ...
    2b50:	50                   	push   %eax
    2b51:	50                   	push   %eax
    2b52:	68 f9 4a 00 00       	push   $0x4af9
    2b57:	6a 01                	push   $0x1
    ...
    2b63:	52                   	push   %edx
    2b64:	52                   	push   %edx
    2b65:	68 d4 4a 00 00       	push   $0x4ad4
    2b6a:	6a 01                	push   $0x1
    ...
    2b76:	51                   	push   %ecx
    2b77:	51                   	push   %ecx
    2b78:	68 bd 4a 00 00       	push   $0x4abd
    2b7d:	6a 01                	push   $0x1
    ...
    2b89:	51                   	push   %ecx
    2b8a:	51                   	push   %ecx
    2b8b:	68 71 4b 00 00       	push   $0x4b71
    2b90:	6a 01                	push   $0x1
    ...
    2baf:	50                   	push   %eax
    2bb0:	50                   	push   %eax
    2bb1:	68 59 4b 00 00       	push   $0x4b59
    2bb6:	6a 01                	push   $0x1
    ...
    2bd5:	50                   	push   %eax
    2bd6:	50                   	push   %eax
    2bd7:	68 34 4b 00 00       	push   $0x4b34
    2bdc:	6a 01                	push   $0x1
    ...
    2be8:	50                   	push   %eax
    2be9:	50                   	push   %eax
    2bea:	68 17 4b 00 00       	push   $0x4b17
    2bef:	6a 01                	push   $0x1
    ...
    2c08:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2c10:	68 95 4b 00 00       	push   $0x4b95
    2c15:	6a 01                	push   $0x1
    ...
    2c23:	68 a6 4b 00 00       	push   $0x4ba6
    ...
    2c3b:	68 a6 4b 00 00       	push   $0x4ba6
    ...
    2c53:	68 5b 42 00 00       	push   $0x425b
    2c58:	e8 8e 0d 00 00       	call   39eb <mkdir>
    link("README", "");
    2c5d:	59                   	pop    %ecx
    2c5e:	58                   	pop    %eax
    2c5f:	68 5b 42 00 00       	push   $0x425b
    2c64:	68 52 4b 00 00       	push   $0x4b52
    2c69:	e8 75 0d 00 00       	call   39e3 <link>
    fd = open("", O_CREATE);
    2c6e:	58                   	pop    %eax
    2c6f:	5a                   	pop    %edx
    2c70:	68 00 02 00 00       	push   $0x200
    2c75:	68 5b 42 00 00       	push   $0x425b
    ...
    2c9a:	68 90 47 00 00       	push   $0x4790
    ...
    2cba:	68 90 47 00 00       	push   $0x4790
  ...
  chdir("/");
    ...
    2cd3:	68 81 3e 00 00       	push   $0x3e81
    2cd8:	e8 16 0d 00 00       	call   39f3 <chdir>
  printf(1, "empty file name OK\n");
    2cdd:	58                   	pop    %eax
    2cde:	5a                   	pop    %edx
    2cdf:	68 d4 4b 00 00       	push   $0x4bd4
    2ce4:	6a 01                	push   $0x1
    ...
    2cf6:	68 ac 4b 00 00       	push   $0x4bac
    2cfb:	6a 01                	push   $0x1
    ...
    2d0a:	68 c0 4b 00 00       	push   $0x4bc0
    2d0f:	6a 01                	push   $0x1
    ...
    2d28:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2d2d:	68 e8 4b 00 00       	push   $0x4be8
    2d32:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2d7b:	68 1a 4c 00 00       	push   $0x4c1a
    2d80:	6a 01                	push   $0x1
    ...
    2d94:	68 f3 4b 00 00       	push   $0x4bf3
    2d99:	6a 01                	push   $0x1
    ...
    2da5:	52                   	push   %edx
    2da6:	52                   	push   %edx
    2da7:	68 07 4c 00 00       	push   $0x4c07
    2dac:	6a 01                	push   $0x1
    ...
    2db8:	50                   	push   %eax
    2db9:	50                   	push   %eax
    2dba:	68 88 53 00 00       	push   $0x5388
    2dbf:	6a 01                	push   $0x1
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2ddf:	68 28 4c 00 00       	push   $0x4c28
    2de4:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3034:	68 d0 4c 00 00       	push   $0x4cd0
    3039:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    306d:	6a 01                	push   $0x1
    306f:	68 91 47 00 00       	push   $0x4791
    ...
    30af:	56                   	push   %esi
    30b0:	57                   	push   %edi
    30b1:	68 33 4c 00 00       	push   $0x4c33
    30b6:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    30c9:	50                   	push   %eax
    30ca:	50                   	push   %eax
    30cb:	68 b5 4c 00 00       	push   $0x4cb5
    30d0:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    30e0:	52                   	push   %edx
    30e1:	52                   	push   %edx
    30e2:	68 71 41 00 00       	push   $0x4171
    30e7:	6a 01                	push   $0x1
    ...
    30fb:	50                   	push   %eax
    30fc:	56                   	push   %esi
    30fd:	68 9c 4c 00 00       	push   $0x4c9c
    3102:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    311d:	68 79 4d 00 00       	push   $0x4d79
    3122:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3132:	50                   	push   %eax
    3133:	56                   	push   %esi
    3134:	68 7c 54 00 00       	push   $0x547c
    3139:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3149:	51                   	push   %ecx
    314a:	51                   	push   %ecx
    314b:	68 4c 54 00 00       	push   $0x544c
    3150:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3160:	57                   	push   %edi
    3161:	56                   	push   %esi
    3162:	68 24 54 00 00       	push   $0x5424
    3167:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3177:	50                   	push   %eax
    3178:	56                   	push   %esi
    3179:	68 ec 53 00 00       	push   $0x53ec
    317e:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    318e:	53                   	push   %ebx
    318f:	53                   	push   %ebx
    3190:	68 81 4c 00 00       	push   $0x4c81
    3195:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    31a5:	56                   	push   %esi
    31a6:	56                   	push   %esi
    31a7:	68 ac 53 00 00       	push   $0x53ac
    31ac:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    31c1:	57                   	push   %edi
    31c2:	57                   	push   %edi
    31c3:	68 65 4c 00 00       	push   $0x4c65
    31c8:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    31d8:	50                   	push   %eax
    31d9:	50                   	push   %eax
    31da:	68 4e 4c 00 00       	push   $0x4c4e
    31df:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3208:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    320e:	68 de 4c 00 00       	push   $0x4cde
    3213:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3257:	5a                   	pop    %edx
    3258:	56                   	push   %esi
    3259:	68 ed 4c 00 00       	push   $0x4ced
  ...
  printf(stdout, "validate ok\n");
    ...
    327c:	68 11 4d 00 00       	push   $0x4d11
    3281:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    329e:	68 f8 4c 00 00       	push   $0x4cf8
    32a3:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
000032c0 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    32ca:	68 1e 4d 00 00       	push   $0x4d1e
    32cf:	ff 35 d0 5e 00 00    	pushl  0x5ed0
  ...
  printf(stdout, "bss test ok\n");
    ...
    32f6:	68 39 4d 00 00       	push   $0x4d39
    32fb:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    330e:	68 28 4d 00 00       	push   $0x4d28
    3313:	ff 35 d0 5e 00 00    	pushl  0x5ed0
...
00003330 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    333a:	68 46 4d 00 00       	push   $0x4d46
  ...
  fd = open("bigarg-ok", 0);
    ...
    335e:	6a 00                	push   $0x0
    3360:	68 46 4d 00 00       	push   $0x4d46
  ...
  unlink("bigarg-ok");
    337e:	c7 04 24 46 4d 00 00 	movl   $0x4d46,(%esp)
    ...
    3390:	c7 04 85 00 5f 00 00 	movl   $0x54a0,0x5f00(,%eax,4)
    3397:	a0 54 00 00 
    ...
    33a3:	51                   	push   %ecx
    33a4:	51                   	push   %ecx
    33a5:	68 50 4d 00 00       	push   $0x4d50
    33aa:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    args[MAXARG-1] = 0;
    ...
    33c6:	68 1d 3f 00 00       	push   $0x3f1d
    33cb:	e8 eb 05 00 00       	call   39bb <exec>
    printf(stdout, "bigarg test ok\n");
    33d0:	59                   	pop    %ecx
    33d1:	58                   	pop    %eax
    33d2:	68 5d 4d 00 00       	push   $0x4d5d
    33d7:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    33dd:	e8 fe 06 00 00       	call   3ae0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    33e2:	58                   	pop    %eax
    33e3:	5a                   	pop    %edx
    33e4:	68 00 02 00 00       	push   $0x200
    33e9:	68 46 4d 00 00       	push   $0x4d46
    ...
    3400:	50                   	push   %eax
    3401:	50                   	push   %eax
    3402:	68 86 4d 00 00       	push   $0x4d86
    3407:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3417:	52                   	push   %edx
    3418:	52                   	push   %edx
    3419:	68 6d 4d 00 00       	push   $0x4d6d
    341e:	ff 35 d0 5e 00 00    	pushl  0x5ed0
    ...
    3439:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    343f:	68 9b 4d 00 00       	push   $0x4d9b
    3444:	6a 01                	push   $0x1
    ...
    34c3:	50                   	push   %eax
    34c4:	68 a8 4d 00 00       	push   $0x4da8
    34c9:	6a 01                	push   $0x1
    ...
    3512:	53                   	push   %ebx
    3513:	68 c4 4d 00 00       	push   $0x4dc4
    3518:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    353c:	50                   	push   %eax
    353d:	68 b4 4d 00 00       	push   $0x4db4
    3542:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    35ee:	68 d4 4d 00 00       	push   $0x4dd4
    35f3:	6a 01                	push   $0x1
...
00003700 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3704:	69 05 cc 5e 00 00 0d 	imul   $0x19660d,0x5ecc,%eax
    370b:	66 19 00 
    370e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3713:	a3 cc 5e 00 00       	mov    %eax,0x5ecc
}
    3718:	c3                   	ret    
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3ca5:	a1 80 5f 00 00       	mov    0x5f80,%eax
{
    ...
    3cc6:	73 10                	jae    3cd8 <free+0x38>
{
  ...
  freep = p;
    ...
    3cf1:	5b                   	pop    %ebx
  freep = p;
    3cf2:	a3 80 5f 00 00       	mov    %eax,0x5f80
}
    3cf7:	5e                   	pop    %esi
    3cf8:	5f                   	pop    %edi
    3cf9:	5d                   	pop    %ebp
  ...
  freep = p;
    3d1a:	a3 80 5f 00 00       	mov    %eax,0x5f80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d40:	8b 3d 80 5f 00 00    	mov    0x5f80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d89:	8b 3d 80 5f 00 00    	mov    0x5f80,%edi
  ...
  return freep;
    3db7:	a1 80 5f 00 00       	mov    0x5f80,%eax
    ...
    3de4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3de7:	a3 80 5f 00 00       	mov    %eax,0x5f80
}
    ...
    base.s.ptr = freep = prevp = &base;
    3e00:	c7 05 80 5f 00 00 84 	movl   $0x5f84,0x5f80
    3e07:	5f 00 00 
    base.s.size = 0;
    3e0a:	bf 84 5f 00 00       	mov    $0x5f84,%edi
    base.s.ptr = freep = prevp = &base;
    3e0f:	c7 05 84 5f 00 00 84 	movl   $0x5f84,0x5f84
    3e16:	5f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3e19:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3e1b:	c7 05 88 5f 00 00 00 	movl   $0x0,0x5f88
    3e22:	00 00 00 
    if(p->s.size >= nunits){
