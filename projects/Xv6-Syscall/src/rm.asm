...
printf(int fd, const char *fmt, ...)
{
 ...
 5e1:	e9 ae fe ff ff       	jmp    494 <printf+0x54>
          s = "(null)";
 5e6:	bb c5 07 00 00       	mov    $0x7c5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 84 0a 00 00       	mov    %eax,0xa84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 84 0a 00 00    	mov    0xa84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 84 0a 00 00    	mov    0xa84,%edi
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 88 0a 00 00       	mov    $0xa88,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 77b:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 782:	00 00 00 
    if(p->s.size >= nunits){
